...
const numLessons = [0, 7, 7, 7, 6, 6, 6];
const start = [510, 555, 615, 675, 735, 795, 845, 890];
const end = [550, 595, 655, 715, 775, 835, 885, 925];
const startLessons = [0, 0, 0, 0, 0, 0, 0];
const subjects = [
    [],
    ['Технология', 'Технология', 'Алгебра', 'Алгебра', 'Хореография', 'Физика', 'СОЧ'],
    ['Геометрия', 'Геометрия', 'Информатика', 'Информатика', 'Русский', 'Русский', 'СОЧ'],
    ['Алгебра', 'Алгебра', 'Биология', 'Физика', 'География', 'Русский', 'СОЧ'],
...
if ((weekday >= 1 && weekday <= 3) && (hours * 60 + mins > 885)) {
    weekday++;
} else if ((weekday >= 4 && weekday <= 6) && (hours * 60 + mins > 835)) {
    weekday++;
} else if (weekday === 0) {
    weekday++;
} else {
