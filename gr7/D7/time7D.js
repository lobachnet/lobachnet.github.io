...
const times = ['8.30 - 9.10', '9.15 - 9.55', '10.15 - 10.55', '11.15 - 11.55', '12.15 - 12.55', '13.15 - 13.55', '14.05 - 14.45', '14.50 - 15.25'];
const numLessons = [0, 6, 8, 7, 6, 7, 5];
const start = [510, 555, 615, 675, 735, 795, 845, 890];
const end = [550, 595, 655, 715, 775, 835, 885, 925];
const startLessons = [0, 0, 0, 0, 0, 0, 0];
const subjects = [
    [],
...
if ((weekday === 2) && (hours * 60 + mins >= 925)) {
    weekday++;
} else if (hours * 60 + mins >= 885 && (weekday === 3 || weekday === 5)) {
    weekday++;
} else if ((weekday === 4 || weekday === 1) && (hours * 60 + mins >= 835)) {
    weekday++;
} else if ((weekday === 6) && (hours * 60 + mins >= 775)) {
    weekday++;
    x = false;
} else if (weekday === 0) {
    weekday++;
...
if (alwaystoday.getDay() != 0 && x === true) highlightCurrentLesson(weekday);
if (alwaystoday.getDay() != 0 && x === true) highlightCurrentBreak(weekday);
