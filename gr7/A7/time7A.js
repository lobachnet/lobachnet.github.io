...
const numLessons = [0, 6, 7, 8, 6, 7, 5];
...
if ((weekday === 1 || weekday === 4) && (hours * 60 + mins > 835)) {
    weekday++;
} else if (hours * 60 + mins >= 885 && (weekday === 2 || weekday === 5)) {
    weekday++;
} else if (weekday === 3 && (hours * 60 + mins > 925)) {
    weekday = 1;
