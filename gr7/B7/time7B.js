...
const numLessons = [0, 8, 7, 8, 6, 5, 5];
...
if ((weekday === 1 || weekday === 3) && (hours * 60 + mins > 925)) {
    weekday++;
} else if (hours * 60 + mins > 885 && weekday === 2) {
    weekday++;
} else if (weekday === 4 && (hours * 60 + mins > 835)) {
    weekday++;
} else if ((weekday === 6 || weekday === 5) && (hours * 60 + mins > 775)) {
    weekday++;
} else if (weekday === 0) {
    weekday++;
} else {
